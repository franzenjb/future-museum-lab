...
export function SlowLookingRoom() {
  ...
  return (
    <section className="min-h-screen bg-background px-5 py-12 sm:px-8 lg:py-20">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.12fr_0.88fr]">
        <div className="min-h-[64vh]">
          <div className="relative flex h-full min-h-[560px] items-end overflow-hidden bg-charcoal">
            ...
            <div className="relative z-10 m-6 max-w-xs text-paper">
        ...
        <aside className="flex flex-col justify-between border-l border-charcoal/15 py-2 pl-0 lg:pl-12">
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-museum-red">
              Slow Looking Room
            </p>
            <h1 className="mt-7 font-serif text-[clamp(3.8rem,8vw,7.25rem)] leading-[0.86] tracking-tight text-balance">
          ...
          <div className="mt-10 space-y-8">
            <div>
              <div className="mb-3 flex items-end justify-between">
                <span className="font-mono text-6xl tracking-tight">
                  {timerLabel}
                </span>
            ...
            <div className="space-y-3">
              {prompts.map((prompt, index) => (
                <div
                  key={prompt}
                  className={`border-l py-4 pl-5 transition ${
                    activePrompt === index
                      ? "border-museum-red text-charcoal"
                      : "border-charcoal/15 text-ash"
                  }`}
                >
